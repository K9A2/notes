...
文中的引用以上标表示。所有源代码都可以在我的 GitHub：[https://github.com/K9A2/DataMining](https://github.com/K9A2/DataMining) 上找到。
...
<div style="text-align: center"><img src="./img/实例数据.png" style="width: 600px"></img></div>
...
<div style="text-align: center"><img src="./img/n维欧几里得距离.jpg"></img></div>
